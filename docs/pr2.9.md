# Práctica 2.9 - Red de ordenadores interconectados mediante un switch

## Descripción de la tarea

Descarga el [siguiente guión](assets/pr2.9.pdf) de implementación de una red de ordenadores interconectados mediante un switch en Cisco Packet Tracer, y realiza todos los pasos que en él se indican. Documenta todo con capturas de pantalla.

## Entrega

Crea un documento PDF, a partir de un Word o Google Docs, con las siguientes consideraciones:

- El nombre del archivo a entregar en la plataforma Moodle Centros debe tener el siguiente formato: `Apellido1Apellido2_Nombre_RL_UD2_P9.pdf`.
