...
![Hilos cable](assets/images/ud4/img19.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img20.png){ widht="400px" }

Cuando ya esté cortado tira del aislamiento hasta dejar ver los 8 hilos cruzados en 4 pares.

![Creación del cable](assets/images/ud4/img21.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img22.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img23.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img24.png){ widht="400px" }
![Creación del cable](assets/images/ud4/img25.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img26.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img27.png){ widht="400px" }
...
![Creación del cable](assets/images/ud4/img28.png){ widht="400px" }
