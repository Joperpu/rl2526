...
Descarga el [siguiente guión](assets/pr2.5.pdf) de implementación de una red con hubs en Cisco Packet Tracer, y realiza todos los pasos que en él se indican. Documenta todo con capturas de pantalla.
